...
Search
% and retrieval is an especially acute problem for sound, as
...
We take three angles.
Nearest neighbor classification to explore the degree to which neighborhoods were preserved.
...
We have explored a range of embeddings learned using a single model and considering various neighborhood relationships.
Interesting to
